...
// NOTE: INJECTED_STYLES is a static string constant containing only CSS.
// It contains no user input or dynamic content — purely hardcoded styling rules.
// dangerouslySetInnerHTML is safe here as the content is developer-controlled.
...
export function CinematicHero({
  ...
  return (
    <div
      ...
      {...props}
    >
      {/* Static CSS styles — no user input, purely developer-controlled constants */}
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        ...
        <button
          onClick={onCtaClick}
          className="btn-cta-hero flex items-center justify-center gap-3 px-10 py-4 rounded-full text-lg font-bold uppercase tracking-wider focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
        >
      ...
      <div className="absolute inset-0 z-20 flex items-center justify-center pointer-events-none" style={{ perspective: "1500px" }}>
        ...
        >
          ...
          <div className="relative w-full h-full max-w-7xl mx-auto px-4 lg:px-12 flex flex-col justify-evenly lg:grid lg:grid-cols-3 items-center lg:gap-8 z-10 py-6 lg:py-0">
            ...
            {/* Phone mockup — RACCORDEMENT DOSSIER TRACKER */}
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      ...
                      <div className="phone-widget flex justify-between items-center mb-6">
                        <div className="flex flex-col">
                          <span className="text-[10px] text-neutral-400 uppercase tracking-widest font-bold mb-1">Suivi dossier</span>
                          <span className="text-xl font-bold tracking-tight text-white drop-shadow-md">Mon raccordement</span>
                        </div>
                        <div className="w-9 h-9 rounded-full bg-blue-500/20 text-blue-300 flex items-center justify-center font-bold text-sm border border-blue-400/20 shadow-lg shadow-black/50">
                      ...
                      <div className="space-y-2.5">
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center">
                          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-500/20 to-emerald-600/5 flex items-center justify-center mr-3 border border-emerald-400/20 shadow-inner">
                            <svg className="w-4 h-4 text-emerald-400 drop-shadow-md" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                            </svg>
                          </div>
                          <div className="flex-1">
                            <div className="text-[11px] font-semibold text-white/90 mb-0.5">Formulaire complete</div>
                            <div className="text-[9px] text-neutral-500">Informations verifiees</div>
                          </div>
                          <div className="text-[9px] text-emerald-400 font-bold">OK</div>
                        </div>
                        ...
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center">
                          ...
                          <div className="flex-1">
                            <div className="text-[11px] font-semibold text-white/90 mb-0.5">Documents valides</div>
                            <div className="text-[9px] text-neutral-500">Plan de masse, permis</div>
                          </div>
                          <div className="text-[9px] text-emerald-400 font-bold">OK</div>
                        </div>
                        ...
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center">
                          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500/20 to-blue-600/5 flex items-center justify-center mr-3 border border-blue-400/20 shadow-inner">
                            <svg className="w-4 h-4 text-blue-400 drop-shadow-md" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                          </div>
                          <div className="flex-1">
                            <div className="text-[11px] font-semibold text-white/90 mb-0.5">Dossier transmis</div>
                            <div className="text-[9px] text-neutral-500">En attente devis Enedis</div>
                          </div>
                          <div className="text-[9px] text-blue-400 font-bold">48h</div>
                        </div>

                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center opacity-40">
                          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-neutral-500/10 to-neutral-600/5 flex items-center justify-center mr-3 border border-neutral-600/20 shadow-inner">
                            <svg className="w-4 h-4 text-neutral-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
                            </svg>
                          </div>
                          <div className="flex-1">
                            <div className="text-[11px] font-semibold text-white/90 mb-0.5">Travaux planifies</div>
                            <div className="text-[9px] text-neutral-500">Intervention Enedis</div>
                          </div>
                        </div>
                      </div>
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Dossier conforme</p>
                    <p className="text-emerald-200/50 text-[10px] lg:text-xs font-medium">Verification terminee</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Devis Enedis</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Reponse sous 48h</p>
                  </div>
                </div>
